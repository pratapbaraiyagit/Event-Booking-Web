...
import ThemeLogo6 from '../../Assets/img/theme-logo6.png';
...
import $ from 'jquery';
import MobileBgBanner from '../../Assets/img/reading-bg.jpeg';
  ...
  const [items, setItems] = useState([
    {
      id: '1',
      size: '1400-933',
      src: 'https://player.vimeo.com/video/810076558',
      thumb: 'https://player.vimeo.com/video/810076558',
    },
  ]);
    ...
    <div className="value_page_wrapper">
      <section className="banner_wrapper vanue_banner">
        <div className="banner_video">
          <iframe
            src="https://player.vimeo.com/video/810076558?background=1&autoplay=1&loop=1&byline=0&title=0"
            frameborder="0"
