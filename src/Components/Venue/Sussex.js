...
import ThemeLogo2 from '../../Assets/img/theme-logo2.png';
...
import $ from 'jquery';
import MobileBgBanner from '../../Assets/img/sussex-bg.jpeg';

export default function Sussex() {
  const lightGallery = useRef(null);
  const [items, setItems] = useState([
    {
      id: '1',
      size: '1400-933',
      src: 'https://player.vimeo.com/video/809828482',
      thumb: 'https://player.vimeo.com/video/809828482',
    },
  ]);
    ...
    <div className="value_page_wrapper">
      <section className="banner_wrapper vanue_banner">
        <div className="banner_video">
          <iframe
            src="https://player.vimeo.com/video/809828482?background=1&autoplay=1&loop=1&byline=0&title=0"
            frameborder="0"
