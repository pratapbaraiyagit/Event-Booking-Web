...
import ThemeLogo4 from '../../Assets/img/theme-logo4.png';
...
import $ from 'jquery';
import MobileBgBanner from '../../Assets/img/syon-west-london-bg.jpeg';

export default function SyonWestLondon() {
  const lightGallery = useRef(null);
  const [items, setItems] = useState([
    {
      id: '1',
      size: '1400-933',
      src: 'https://player.vimeo.com/video/403277191',
      thumb: 'https://player.vimeo.com/video/403277191',
    },
  ]);
    ...
    <div className="value_page_wrapper">
      <section className="banner_wrapper vanue_banner">
        <div className="banner_video">
          <iframe
            src="https://player.vimeo.com/video/403277191?background=1&autoplay=1&loop=1&byline=0&title=0"
            frameborder="0"
